...
const filterGrid = [
    ...
    new Filter('Tiny Face', 'mask1.png', 'faceDistortion', {center_point: 2, distortion_kwargs: {effectRadius: 0.1, distortionStrength: 2}}),
    new Filter('Tiny Head', 'mask1.png', 'faceDistortion', {center_point: 2, distortion_kwargs: {effectRadius: 0.2, distortionStrength: 1}}),
    new Filter('Big Head', 'mask1.png', 'faceDistortion', {center_point: 2, distortion_kwargs: {effectRadius: 0.4, distortionStrength: -0.4}}),
    new Filter('Big Nose', 'mask1.png', 'faceDistortion', {center_point: 2, distortion_kwargs: {effectRadius: 0.1, distortionStrength: -1}}),
    new Filter('Big Mouth', 'mask1.png', 'faceDistortion', {center_point: 3, distortion_kwargs: {effectRadius: 0.1, distortionStrength: -1}}),
