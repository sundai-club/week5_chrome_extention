...
const filterGrid = [
    ...
    new Filter('Tiny Face', 'tiny_face.png', 'faceDistortion', {center_point: NOSE_IDX, effectRadius: 1, distortion_kwargs: {distortionStrength: 2}}),
    new Filter('Tiny Head', 'mask1.png', 'faceDistortion', {center_point: NOSE_IDX, effectRadius: 2.4, distortion_kwargs: {distortionStrength: 1}}),
    new Filter('Big Head', 'big_head.png', 'faceDistortion', {center_point: NOSE_IDX, effectRadius: 4.8, distortion_kwargs: {distortionStrength: -0.4}}),
    new Filter('Big Nose', 'big_nose.png', 'faceDistortion', {center_point: NOSE_IDX, effectRadius: 1.2, distortion_kwargs: {distortionStrength: -1}}),
    new Filter('Big Mouth', 'big_mouth.png', 'faceDistortion', {center_point: MOUTH_IDX, effectRadius: 1.2, distortion_kwargs: {distortionStrength: -1}}),
    new Filter('Tiny Mouth', 'mask1.png', 'faceDistortion', {center_point: MOUTH_IDX, effectRadius: 1.2, distortion_kwargs: {distortionStrength: 1}}),
    ...
    new Filter('Central Distortion 3', 'positive_central_distortion.png', 'centralDistortion', {distortionStrength: 1}),
    new Filter('Central Distortion 4', 'negative_central_distortion.png', 'centralDistortion', {distortionStrength: -1}),
